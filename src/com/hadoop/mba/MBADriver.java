...
public class MBADriver extends Configured implements Tool {
   ...
   public static void main(String args[]) throws Exception {
	  ...
	  args = new String[] {"./temp", "./output_MBA" , "2"};
   ...
   public int run(String args[]) throws Exception {
      ...
      // job configuration
      // Change made as new Job(getConf()) is deprecated. 
     // Job job = new Job(getConf());
      ...
      // add jars to distributed cache
       ...
       /* The below line seems to be for a distributed environment*/
      ...
      THE_LOGGER.debug("Status : " + status);
